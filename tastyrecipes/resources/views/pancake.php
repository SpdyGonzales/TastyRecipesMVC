...
$xml=simplexml_load_file("../../classes/xml/recipes.xml") or die("Error: Cannot create object");
?>
  ...
  <body>
      ...
      <nav id="navbar">
        <ul>
          ...
          <li><a class="dropdown">SignUp/Login</a>
            <ul class="dropdown--menu">
              <li><form action="../../classes/Util/signup.php" method="POST">
                    <p>SignUp</p>
                  ...
                  <form action="../../classes/Util/login.php" method="POST">
                  <p>Login</p>
                  <input type="text" name="uid" placeholder="Username"><br>
                  <input type="password" name="pwd" placeholder="Password"><br>
    ...
    <article class="recipe">
      ...
      ?>
       ...
       <?php 
       $recipesite = "pancakes";
        include "../../classes/Util/comments.php";
       ?>
       <div class="spacer"></div>
    </article>
  </body>
